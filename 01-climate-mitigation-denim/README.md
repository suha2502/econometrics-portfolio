...
This research considers how a hypothetical Pigouvian tax on Canadian denim jeans would affect their sales, water usage, and carbon emissions. Time-series data on global denim fabric imports from the World Integrated Trade Solution are used to construct jeans-level price and quantity estimates. Published life-cycle environmental cost factors serve as inputs for counterfactual models projecting the ecological benefits of internalizing denim's negative externalities. A first-differenced log-log demand model estimates a short-run own-price elasticity of -1.57. Applying a +20% price shock—calibrated to combined carbon and water costs—in 2023 predicts a 24% decline in demand from 2022, translating into savings of 0.5 tonnes CO₂-eq emissions and 61 million litres of water. Simplifying assumptions, necessitated by limited public market data and a partial-equilibrium methodology, temper confidence in these first-order approximations. Policy implementation, feasibility, and associated trade-offs are rigorously evaluated.

## Motivation

This capstone project was developed over a semester-long course in which I independently designed an original mitigation policy from the ground up. It presented a terrific opportunity to meld my deep-rooted interests in fashion and climate justice within an economic framework, exploring policy levers to mollify the tension between denim's cultural allure and its material reality as one of our planet's most resource-intensive textiles. I sought to quantify the effects of corrective pricing in this market and discern whether it could precipitate responsible, sustainable redirection in an industry emblematic of waste. Set against the backdrop of a relentless fast fashion and influencer-driven economy, this study offers one take on how policy design could quell socially irresponsible consumption by tethering it directly to personal responsibility.
